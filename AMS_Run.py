...
def manually_fill():
    ...
    def err_screen_for_subject():
        ...
        Label(ec, text='Please enter your subject name!!!', fg='red', bg='black', font=('times', 16, ' bold ')).pack()
        Button(ec, text='OK', command=ec_delete, fg="white", bg="lawn green", width=9, height=1, activebackground="Red",
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def err_screen1():
                ...
                Label(errsc2, text='Please enter Student & Enrollment!!!', fg='red', bg='black',
            ...
            def create_csv():
                ...
                csv_name='C:/Users/abhin/Downloads/Warmhole 164ly/Attendence/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:/Users/abhin/Downloads/Warmhole 164ly/Attendence\-------Check atttendance-------"')
...
def err_screen():
    ...
    Label(sc1,text='Enrollment & Name required!!!',fg='red',bg='black',font=('times', 16, ' bold ')).pack()
    Button(sc1,text='OK',command=del_sc1,fg="white"  ,bg="lawn green"  ,width=9  ,height=1, activebackground = "Red" ,font=('times', 15, ' bold ')).place(x=90,y= 50)
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='snow')
                cs = 'C:/Users/abhin/Downloads/Warmhole 164ly/Attendence/' + fileName
    ...
    def log_in():
        ...
        if username == 'admin' :
            if password == 'admin':
                ...
                cs = 'C:/Users/abhin/Downloads/Warmhole 164ly/Attendence/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
def trainimg():
    # Check if face recognizer can be created
    try:
        recognizer = cv2.face.LBPHFaceRecognizer_create()
